          ...
          <div>
            ...
            {positions.map((position) => {
              ...
              if (
                ...
                position.collateralToken.fundingRate
              ) {
                const borrowFeeRate = position.collateralToken.fundingRate
                  .mul(position.size)
                  .mul(24)
                  .div(FUNDING_RATE_PRECISION);
                borrowFeeText = `Borrow Fee / Day: $${formatAmount(
                  borrowFeeRate,
                  USD_DECIMALS,
                  2,
                  true,
                    ...
                    <div className="App-card-row">
                      <div className="label">
                        <Tooltip
                          ...
                          renderContent={() => (
                            <div>
                              You can change in settings to show leverage
                              {savedIsPnlInLeverage
                                ? " without PnL"
                                : " including PnL"}
                              .
                            ...
                            return (
                              <>
                                {position.hasLowCollateral && (
                                  <div>
                                    WARNING: This position has a low amount of
                                    collateral after deducting borrowing fees,
                                    deposit more collateral to reduce the
                                    position's liquidation risk.
                                    <br />
                                    <br />
                                  </div>
                                )}
                                ...
                                <br />
                                Use the "Edit" button to deposit or withdraw
                                collateral.
                              </>
                            );
                          }}
                          ...
                          renderContent={() => {
                            return (
                              <>
                                ...
                                <br />
                                PnL After Fees: {position.deltaAfterFeesStr} (
                        ...
                        {positionOrders.map((order) => {
                          const orderText = () => (
                            <>
                              ...
                              {order.type === INCREASE ? " +" : " -"}$
                              {formatAmount(order.sizeDelta, 30, 2, true, undefined, 0)}
                            </>
                          );
                          if (order.error) {
                            return (
                  ...
                  <div className="App-card-options">
                    ...
                    >
                      <Tooltip
                        ...
                        renderContent={() => (
                          <div>
                            Position sharing will display after-fee performance.
                          </div>
                        )}
                      />
                    </button>
        ...
        <tbody>
            ...
            <th>
              <Tooltip
                ...
                renderContent={() => (
                  <div>
                    You can change in settings to show leverage
                    {savedIsPnlInLeverage ? " without PnL" : " including PnL"}.
                  </div>
                )}
              />
            </th>
          ...
          {positions.map((position) => {
            const liquidationPrice =
              getLiquidationPrice(position) || bigNumberify(0);
            const positionOrders = getOrdersForPosition(
              position,
              orders,
              nativeTokenAddress
                      ...
                      return (
                        <>
                          {position.hasLowCollateral && (
                            <div>
                              WARNING: This position has a low amount of
                              collateral after deducting borrowing fees, deposit
                              more collateral to reduce the position's
                              liquidation risk.
                              <br />
                              <br />
                            </div>
                ...
                >
                  <Tooltip
                    ...
                    renderContent={() => {
                      return (
                        <>
                          Click on a row to select the position's market, then
                          use the swap box to increase your position size if
                          needed.
                          <br />
                          <br />
                          Use the "Close" button to reduce your position size,
                          or to set stop-loss / take-profit orders.
                        </>
                      );
                    }}
                  />
