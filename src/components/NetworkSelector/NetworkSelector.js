...
export default function NetworkSelector(props) {
  ...
  function renderOption(option) {
    const optionIcon = require("../../img/" + option.icon);
    return (
      <div
  ...
  function Option(props) {
    const className = cx(props.className, props.data.label.toLowerCase());
  ...
  function SingleValue({ data, ...props }) {
    const icon = require("../../img/" + data.icon);
    return (
    ...
    <div className={cx("Selector", className, { disabled })}>
      ...
      {small ? (
        ...
        <Select
          ...
          styles={customStyles}
          getOptionLabel={(e) => {
            const optionIcon = require("../../img/" + e.icon);
            return (
              <div style={{ display: "flex", alignItems: "center" }}>
                <img
                  src={optionIcon.default}
