import { ChainId, ContractKey } from '../utils/types';
import { chainIds } from './Constants';

const CONTRACTS: { [x in ChainId]: { [key in ContractKey]: string } } = {
...
export function getContract(chainId: ChainId, name: ContractKey): string {
